                                ...
                                <tbody>
                                    @foreach ($periodos as $periodo)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('periodos.toggle', $periodo->id) }}" method="POST">
                                                    @method('PUT')
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-{{ $periodo->estado === 'Activado' ? 'success' : 'danger' }}">
                                                        {{ $periodo->estado }}
                                                    </button>
                                                </form>
                                            </td>
