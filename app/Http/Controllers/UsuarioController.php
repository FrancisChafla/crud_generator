...
public function cambiarEstado($id)
{
    $usuario = Usuario::find($id);
    if ($usuario) {
        // Cambiar el estado de "activado" a "desactivado" y viceversa
        $nuevoEstado = ($usuario->estado === 'activado') ? 'desactivado' : 'activado';
        $usuario->update(['estado' => $nuevoEstado]);
    }

    return redirect()->route('usuarios.index')->with('success', 'Estado cambiado exitosamente.');
}
