...
class CarreraController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('carrera.create', compact('carrera','usuarios'));
    }
    ...
    public function edit($id)
    {
        $carrera = Carrera::find($id);
        $usuarios = Usuario::pluck('nombre', 'id');
        return view('carrera.edit', compact('carrera','usuarios'));
    }
    ...
    public function toggle($id)
    {
        ...
        if ($carrera) {
            $carrera->estado = ($carrera->estado == 'Activado') ? 'Desactivado' : 'Activado';
            $carrera->save();
        }

        return redirect()->route('carreras.index')
            ->with('success', 'Carrera state toggled successfully');
    }
}
